...
- **Using this project's research to attack systems without authorization, or
  encouraging others to do so** (see `SECURITY.md`)
...
method listed in `CONTRIBUTING.md`. All complaints will be reviewed and
